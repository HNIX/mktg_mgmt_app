...
class ActionItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create action_item" do
    assert_difference('ActionItem.count') do
      post action_items_url, params: { action_item: { description: @action_item.description, due_date: @action_item.due_date, name: @action_item.name, status: @action_item.status } }
    end
  ...
  test "should update action_item" do
    patch action_item_url(@action_item), params: { action_item: { description: @action_item.description, due_date: @action_item.due_date, name: @action_item.name, status: @action_item.status } }
